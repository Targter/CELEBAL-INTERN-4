      ...
      >
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-4">
            <button
              onClick={() => setShowProjectModal(true)}
              className="text-white px-3 py-2 rounded-lg bg-opacity-20 hover:bg-opacity-90 cursor-pointer text-sm sm:text-base"
              style={{ backgroundColor: customColor }}
            >
              Add Project
            </button>
            <button
              onClick={() => setShowBatchModal(true)}
              className="px-3 py-2 text-white rounded-lg hover:bg-opacity-90 cursor-pointer text-sm sm:text-base"
              style={{ backgroundColor: customColor }}
            >
              Add Batch
            </button>
            ...
            {(selectedBatch || selectedProject || selectedTask) && (
              <button
                onClick={clearSelection}
                className="bg-red-500 text-white px-3 py-2 rounded-lg hover:bg-red-600 cursor-pointer text-sm sm:text-base"
              >
                Clear Selection
              </button>
            )}
        ...
        >
          <motion.div
            className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-lg border-t-4 border-theme hover:shadow-xl transition-all duration-300"
            whileHover={{ scale: 1.02 }}
            style={{ backgroundColor, color: fontColor }}
          >
            <div className="flex items-center space-x-4">
              <svg
                className="w-6 h-6 sm:w-8 sm:h-8 text-theme"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div>
                <h2
                  className="text-base sm:text-lg font-semibold text-gray-700 dark:text-gray-200"
                  style={{ color: fontColor }}
                >
                  Total Projects
                </h2>
                <p
                  className="mt-2 text-2xl sm:text-3xl font-bold text-theme"
                  style={{ color: fontColor }}
                >
                  {projects.length}
                </p>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2
                  className="text-base sm:text-lg font-semibold dark:text-gray-200 text-theme"
                  style={{ color: fontColor }}
                >
                  Active Batches
                </h2>
                <p className="mt-2 text-2xl sm:text-3xl font-bold text-theme">
                  {batches.length}
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h2
              className="text-base sm:text-lg md:text-xl font-semibold text-gray-700 dark:text-gray-200 mb-4"
              style={{ color: customColor }}
            >
              Task List
            </h2>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
                <h2
                  className="text-base sm:text-lg md:text-xl font-semibold text-gray-700 dark:text-gray-200"
                  style={{ color: customColor }}
                >
                  {reportType === "project"
                    ? `Project Reports - ${selectedProject?.name || ""}`
                ...
                {(selectedBatch || selectedProject || selectedTask) && (
                  <button
                    onClick={clearSelection}
                    className="px-3 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 text-sm sm:text-base"
                  >
                    Clear Selection
                  </button>
                )}
