...
const Board = () => {
  ...
  return (
    <div
      className="p-2 sm:p-4 md:p-6 rounded-xl shadow-lg mb-11"
      style={{ backgroundColor: `${customColor}22`, color: fontColor }}
    >
      <motion.div
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5 }}
        className="mb-4 sm:mb-6 flex p-3 sm:p-4 flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4"
        style={{
          backgroundColor: `${backgroundColor}cc`,
          color: fontColor,
        }}
      >
        <motion.h2
          className="text-xl sm:text-2xl md:text-3xl font-extrabold break-words"
          style={{ color: fontColor }}
          whileHover={{ scale: 1.05 }}
        >
          Kanban Board: {selectedBatch.name}
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1 sm:p-2 rounded-full hover:bg-opacity-30"
                        style={{ color: fontColor }}
                        aria-label={`Add task to ${column.title}`}
                      >
      ...
      >
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center mt-1 sm:mt-2 text-sm sm:text-base"
          style={{ color: fontColor }}
        >
      ...
      <ToastContainer
        // position={ < 640 ? "top-center" : "top-right"}
        autoClose={3000}
      />
    </div>
  );
